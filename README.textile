...
@wget --no-check-certificate https://github.com/anithri/oh-my-zsh/raw/master/tools/install.sh -O - | sh@
...
1. Clone the repository
  ...
  @git clone git://github.com/anithri/oh-my-zsh.git ~/.oh-my-zsh@
...
** Take a look at the "current themes":https://wiki.github.com/anithri/oh-my-zsh/themes that come bundled with _Oh My Zsh_.
...
* "View our growing list of contributors":https://github.com/anithri/oh-my-zsh/contributors
